...
describe("Exchange", () => {
  ...
  describe("Depositing tokens", () => {
    ...
    describe("Success", () => {
      ...
      await expect(transaction).to.emit(exchange,"TokensDeposited").withArgs(
   ...
   describe("Withdrawing tokens", () => {
    ...
    describe("Success", () => {
      ...
      await expect(transaction).to.emit(exchange,"TokensWithdrawn").withArgs(
        await token0.getAddress(),
        accounts.user1.address,
        AMOUNT,
        0
    ...
    describe("Failure", () => {
     it("fails for insufficient balances", async () => {
      ...
      await expect(exchange.connect(accounts.user1).withdrawToken(
        await token0.getAddress(), AMOUNT)).to.be.revertedWith(ERROR)
     })
    })
  })
  ...
  describe("Making Orders", () => {
    describe("Success", () => {
      ...
      await expect(transaction).to.emit(exchange, "OrderCreated").withArgs(
        ORDER_ID,
        accounts.user1.address,
  ...
  describe("Filling Orders", () => {
    describe("Success", () => {
      ...
      it("emits an order filled event", async () => {
        ...
        await expect(transaction).to.emit(exchange, "OrderFilled").withArgs(
          1,
    ...
    describe("Failure", () => {
     it("rejects invalid order ids", async () => {
      ...
      await expect( exchange.connect(accounts.user2).fillOrder(9999)).to.be.revertedWith(ERROR)
      })
