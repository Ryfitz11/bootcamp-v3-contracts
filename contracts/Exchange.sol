...
contract Exchange {
    ...
    function _trade(
        ...
        userTotalTokenBlance[_tokenGet][msg.sender] -= (_amountGet +
            _feeAmount);
        userTotalTokenBlance[_tokenGet][_user] += _amountGet;

        userTotalTokenBlance[_tokenGet][feeAccount] += _feeAmount;

        userTotalTokenBlance[_tokenGive][_user] -= _amountGive;
        userTotalTokenBlance[_tokenGive][msg.sender] += _amountGive;

        userActiveTokenBlance[_tokenGive][_user] -= _amountGive;
